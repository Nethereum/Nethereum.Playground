...
namespace NetDapps.Compiler.Services
{
    internal class InvocationContext
    {
        ...
        public InvocationContext(SemanticModel semModel, int position, SyntaxNode receiver, ArgumentListSyntax argList, bool isStatic = false)
        {
        ...
        public InvocationContext(SemanticModel semModel, int position, SyntaxNode receiver, AttributeArgumentListSyntax argList, bool isStatic = false)
        {
            SemanticModel = semModel;
            Position = position;
            Receiver = receiver;
