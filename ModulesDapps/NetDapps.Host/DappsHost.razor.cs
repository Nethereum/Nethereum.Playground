...
namespace NetDapps.Host
{
    ...
    public class DappHostViewModel:ComponentBase
    {
        ...
        public bool MetamaskRegistered { get; set; }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var loaded = await Client.GetFromJsonAsync<UIAssemblyLoadInfo[]>("uiAssemblies.json");
        ...
        {
            Loading = AssemblyCacheInitialiser.IsInitialised();
            AssemblyCacheInitialiser.WhenReady(LoadSelectedInternal);
        }
